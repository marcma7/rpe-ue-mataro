...
async function carregarLesions(){
    ...
    injuries.forEach(lesio=>{
        ...
        physioVisits.filter(
            v =>
            v.episode_uuid === lesio.episode?.uuid
        );
...
if(visitaFeta){
    ...
    lesio.visites_fetes = 1;

}
else{

    lesio.visites_fetes = 0;
...
function filtrarLesions(){
    ...
    else if(filtre === "Pendent de donar hora"){
