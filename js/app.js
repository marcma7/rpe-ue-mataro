...
document
.getElementById("valoracionsButton")
.onclick = async ()=>{
...
document
.getElementById("novaPreguntaButton")
.onclick = () => {
    obrirNovaPregunta();
};
...
document
.getElementById("questionarisButton")
.addEventListener(
"click",
async ()=>{
...
const botoConfirmar =
    document.getElementById("confirmarRPEButton");
...
document
    .getElementById("confirmarQuestionariButton")
...
document
.getElementById("passarValoracioButton")
.addEventListener(
"click",
async()=>{
...
document
    .getElementById("nouEquipButton")
    .addEventListener("click", crearEquip);
...
async function iniciarAplicacio() {
    ...
    if (!user) {
        ...
        alert(
            "La informació d'aquest usuari ha canviat o ha estat eliminat."
        );
...
async function entrar() {
    ...
    if (!user) {
        ...
        alert(
            "Aquest codi no està a la base de dades."
        );
...
async function decideRoute(user) {
    ...
    const questionaris =
        await getQuestionarisPerContestar(user.uuid);
...
document.getElementById("pantallaAddValoracioItem").style.display="none";
    ...
    if (pantalla === "rpe") {
        document.getElementById("pantallaRPE").style.display = "flex";
    }

    if (pantalla === "questionaris") {
        document.getElementById("pantallaQuestionaris").style.display = "flex";
    }

    if (pantalla === "management") {
        document.getElementById("pantallaManagement").style.display = "flex";
    }

    if (pantalla === "teams") {
    document.getElementById("pantallaTeams").style.display = "flex";
}

if (pantalla === "sessions") {
    document.getElementById("pantallaSessions").style.display = "flex";
}

if (pantalla === "modifySessions") {
    document.getElementById("pantallaModifySessions").style.display = "flex";
}

if (pantalla === "deleteSessions") {
    document.getElementById("pantallaDeleteSessions").style.display = "flex";
}

if (pantalla === "dades") {
    document.getElementById("pantallaDades").style.display = "flex";
}


if (pantalla === "seleccionValoracio") {
    document.getElementById("pantallaSeleccionValoracio").style.display = "flex";
}

if (pantalla === "passValoracio") {
    document.getElementById("pantallaPassarValoracio").style.display = "flex";
}

if (pantalla === "fisio") {

    document
    .getElementById("pantallaFisio")
    .style.display="flex";
...
if (pantalla === "lesions") {
    ...
    document
    .getElementById("pantallaLesions")
    .style.display="flex";

}

if(pantalla==="assignarHora"){
...
if(pantalla==="visites"){
    ...
    document
    .getElementById("pantallaVisites")
    .style.display="flex";

}

if(pantalla==="infoVisita"){

    document
    .getElementById("pantallaInfoVisita")
    .style.display="flex";

}

if(pantalla==="afegirLesio"){

    document
    .getElementById("pantallaAfegirLesio")
    .style.display="flex";

}

if(pantalla==="gestioQuestionaris"){

    document
    .getElementById("pantallaGestioQuestionaris")
    .style.display="flex";

}

if(pantalla==="enviarQuestionari"){

    document
    .getElementById("pantallaEnviarQuestionari")
    .style.display="flex";

}

if (pantalla === "questions") {
    document.getElementById("questions").style.display = "flex";
}

if (pantalla === "addQuestion") {
    document.getElementById("addQuestion").style.display = "flex";
}

if(pantalla==="gestioValoracions")
    document.getElementById("pantallaGestioValoracions").style.display="flex";

if(pantalla==="valoracioItems")
    document.getElementById("pantallaValoracioItems").style.display="flex";

if(pantalla==="addValoracioItem")
    document.getElementById("pantallaAddValoracioItem").style.display="flex";
